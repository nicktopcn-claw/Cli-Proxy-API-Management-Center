      ...
      <Card
        ...
        extra={
          <Button size="sm" onClick={onAdd} disabled={actionsDisabled}>
            {t('ai_providers.embeddings_add_button')}
          </Button>
        }
      >
        <ProviderList<OpenAIProviderConfig>
          items={configs}
          loading={loading}
          keyField={(_, index) => `embeddings-provider-${index}`}
          emptyTitle={t('ai_providers.embeddings_empty_title')}
          emptyDescription={t('ai_providers.embeddings_empty_desc')}
          onEdit={onEdit}
          onDelete={onDelete}
